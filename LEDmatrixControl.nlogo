...
to init-matrix
  write-list (sentence binary-list-for-hex-digit-string "9" fourzeros)  (sentence fourzeros fourzeros)
  write-list (sentence binary-list-for-hex-digit-string "A" fourzeros)  (sentence binary-list-for-hex-digit-string "3" fourzeros)
  write-list (sentence binary-list-for-hex-digit-string "B" fourzeros)  (sentence binary-list-for-hex-digit-string "7" fourzeros)
  write-list (sentence binary-list-for-hex-digit-string "C" fourzeros)  (sentence binary-list-for-hex-digit-string "1" fourzeros)
  write-list (sentence binary-list-for-hex-digit-string "F" fourzeros)  (sentence fourzeros fourzeros)
end
...
to write-list [ address alist]
  gpio:digital-write CS_PIN "LOW"
  write-byte binary-list-for-hex-digit-string address
  write-byte alist
  gpio:digital-write CS_PIN "HIGH"
end

;reports a 4-elment binary list, least significant digit first. [maybe should be most-sig?]
to-report binary-list-for-hex-digit-string [ hdigit ]
  ...
  [
   ...
   set rlist replace-item xponent rlist v 
...
to send-horizontal-row [rownum alist]
  ...
  [
    ...
    ifelse index = rownum
    [ write-list (word index) alist ]
    [ write-list (word index) zerorow ]
  ] 
end
