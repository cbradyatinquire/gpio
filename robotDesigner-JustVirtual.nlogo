    ...
    [
       ...
       [
         ...
         ask grabbed-robot [
            ...
            if grab-counter mod 10 = 0 [ set heading heading + 1 ] 
         ] 
       ] 
    ]
    [
...
to draw-walls
  ...
  [
   set mouse-was-down? true
   let new-wall-patches (patch-set patch mouse-xcor mouse-ycor   patch (mouse-xcor + 1) mouse-ycor  patch (mouse-xcor + 1) (mouse-ycor - 1)    patch mouse-xcor ( mouse-ycor - 1)) 
